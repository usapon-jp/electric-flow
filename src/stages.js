export const stages = [
  {name:'はじめての回路',section:0,title:'電池・電球・スイッチをつなごう。',intro:'端子を2つタップして、ひとつながりに。',hint:'電池・電球・スイッチを、輪になるようにつなぎます。',insight:'ひとつながりになると、電流が流れる。'},
  {name:'電流の道',section:0,title:'スイッチを開くと、電流はどうなる？',intro:'スイッチを開くと、どうなる？',hint:'切れ目があると、回路全体の電流が止まります。',insight:'電流は、外側の回路を＋から−へ。'},
  {name:'電流をはかる',section:1,title:'電球の前と、後では？',intro:'導線の途中をタップして、電流計を入れる。',hint:'電流計は、導線を切ったところへ直列につなぎます。',insight:'電流は、電球を通っても減らない。'},
  {name:'電圧をはかる',section:1,title:'電球・電池・導線の電圧をはかろう。',intro:'はかりたい2つの端子をタップ。',hint:'電圧計は、はかりたい部分の両端へ。',insight:'電流は途中で。電圧は両端で。'},
